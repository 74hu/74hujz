...
if p=1 then
             HU="今日链入排行"
             gettxt="where [Active] =0 and del=0 and DATEDIFF('d', HU_time, now())=0"
             elseif p=2 then 
             HU="昨日链入排行"
             gettxt="where [Active] =0 and del=0 and DATEDIFF('d', HU_time, now())=1"
             elseif p=3 then 
             HU="本周链入排行"
             gettxt="where [Active] =0 and del=0 and DATEDIFF('d', HU_time, now())<8"
             elseif p=4 then 
             HU="月链入排行"
             gettxt="where [Active] =0 and del=0 and DATEDIFF('d', HU_time, now())<31"
             else
             HU="总链入排行"
