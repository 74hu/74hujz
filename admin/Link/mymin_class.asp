...
Sql="select * from 74hu_link Where classid="&idd&" order by HU_time desc"
rs.open Sql,conn,1,1
If Not rs.eof	Then
Dim PageSize,i
	PageSize=15							
	Dim Count,page,pagecount,gopage	
	gopage="mymin_class.asp?sid="&sid&"&amp;id="&idd&"&amp;"
	Count=conn.execute("Select count(ID) from 74hu_link where classid="&idd&"")(0)
